...
/**
 * Admin options – adds legal notice under settings.
 */
public function admin_options() {
    parent::admin_options();
    echo '<p style="margin-top:30px;font-size:12px;color:#777;border-top:1px solid #ddd;padding-top:10px;">'
       . '<strong>Legal Notice:</strong> '
       . esc_html__('This plugin is an independent software product developed by third parties and is not affiliated with, endorsed by, or sponsored by Revolut. “Revolut” and related trademarks are the property of Revolut Ltd.', 'gatespark-revolut')
       . '</p>';
}
}