 ...
 *
* Legal Notice:
* This plugin is an independent software product developed by third parties and is
* not affiliated with, endorsed by, or sponsored by Revolut.
* “Revolut” and related trademarks are the property of Revolut Ltd.
* All references to the Revolut brand are strictly for technical integration purposes.
*/
if (!defined('ABSPATH')) {
    exit;
}
